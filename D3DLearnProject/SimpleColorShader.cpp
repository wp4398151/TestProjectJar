...
bool SimpleColorShader::Render(ID3D11DeviceContext *pDeviceContext,
	int indexCount,
...
void SimpleColorShader::Shutdown()
{
	if (m_pLayout)
	{
		m_pLayout->Release();
...
bool SimpleColorShader::Init(ID3D11Device *pDevice, HWND hwnd)
{
	HRESULT res = S_OK;
...
bool SimpleColorShader::RenderShader(ID3D11DeviceContext *pDeviceContext,
	int indexCount)
{
...
bool SimpleColorShader::SetShaderParam(ID3D11DeviceContext *pDeviceContext,
	D3DXMATRIX worldMatrix,
	D3DXMATRIX viewMatrix,
	D3DXMATRIX projectionMatrix)
{
