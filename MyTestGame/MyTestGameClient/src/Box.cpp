...
VertexType g_BoxVertices[] = {
	...
	{ D3DXVECTOR3(-1.0f, -1.0f, -1.0f), D3DXVECTOR4(0.0f, 1.0f, 0.0f, 1.0f), D3DXVECTOR2(0.0f, 0.0f)},
	{ D3DXVECTOR3(-1.0f, 1.0f, -1.0f), D3DXVECTOR4(0.0f, 1.0f, 0.0f, 1.0f), D3DXVECTOR2(0.0f, 0.0f)},
...
bool Box::InitializeBuffers(ID3D11Device* pDevice)
{
	...
	// 指向保存顶点数据的临时缓冲.
	vertexData.pSysMem = g_BoxVertices; // 将三角形的顶点数据放入顶点缓冲中
	...
	// 指向保存顶点数据的临时缓冲.
	indexData.pSysMem = g_BoxIndexVertice; // 将三角形的顶点数据放入顶点缓冲中
